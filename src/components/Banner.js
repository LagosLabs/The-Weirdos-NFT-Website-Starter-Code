...
const Banner = () => {
  return (
    <Section>
      <ImgContainer>
        <img src={img1} alt="Streamillonaire DAO NFTs" />
        <img src={img2} alt="Streamillonaire DAO NFTs" />
        <img src={img3} alt="Streamillonaire DAO NFTs" />
        <img src={img4} alt="Streamillonaire DAO NFTs" />
        <img src={img5} alt="Streamillonaire DAO NFTs" />
        <img src={img6} alt="Streamillonaire DAO NFTs" />
      </ImgContainer>
